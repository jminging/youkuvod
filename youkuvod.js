(function()
{
    ...
    var ckjs = 'http://q2234037172.host39.com/vod/ckplayer/ckplayer.js';
    var ckswf = 'http://q2234037172.host39.com/vod/ckplayer/ckplayer.swf';

    /*
   
 var ckjs = 'http://xinshangshangxin.chinacloudsites.cn/vod/ckplayer/ckplayer.js';
    var ckswf = 'http://xinshangshangxin.chinacloudsites.cn/vod/ckplayer/ckplayer.swf';
    */
...
*/
    ...
    function start(u, ss)
    {
        ...
        loadjs = document.createElement('script');
        loadjs.type = 'text/javascript';
        loadjs.innerHTML = "var flashvars={f:'" + u + "',c:0,v:80,s:'" + ss + "',p:1,g:'" + ptime + "'};var params={bgcolor:'#FFF',allowFullScreen:true,allowScriptAccess:'always'};CKobject.embedSWF('" + ckswf + "','" + playid + "','syplayer','100%','100%',flashvars,params);";
        document.getElementsByTagName('body')[0].appendChild(loadjs);
    }
    ...
    function showbutton(hd)
    {
        ...
        {
            console.log(hd)
            qxdiv.innerHTML += '<input type="button" onclick = "CKobject.getObjectById(\'syplayer\').ckplayer_newaddress(\'{f->' + urlanswer[1] + '}{g->' + ptime + '}\');" value="超清" style="display:block;border:none;background:none;">';
        ...
        {
            qxdiv.innerHTML += '<input type="button"  onclick = "CKobject.getObjectById(\'syplayer\').ckplayer_newaddress(\'{f->' + urlanswer[2] + '}{g->' + ptime + '}\');" value="高清" style="display:block;border:none;background:none;">';
        }
        else if (hd == 3)
        {
            qxdiv.innerHTML += '<input type="button"  onclick = "CKobject.getObjectById(\'syplayer\').ckplayer_newaddress(\'{f->' + urlanswer[3] + '}{g->' + ptime + '}\');" value="标清" style="display:block;border:none;background:none;">';
        }
    }
